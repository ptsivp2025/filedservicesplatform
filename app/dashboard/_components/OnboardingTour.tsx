...
const ALL_STEPS: TourStep[] = [
  {
    ...
    title: 'Selamat datang di Field Service Platform!',
    desc: 'Platform Proof of Execution IndoVisual — pastikan PIC yang tepat bekerja di lokasi yang tepat, sesuai jadwal, divalidasi GPS dan bukti foto. Panduan ini akan memandu kamu langkah demi langkah.',
  ...
  },
  {
    ...
    desc: 'Kamu sudah mengenal semua fitur Field Service Platform. Klik menu di sidebar untuk memulai. Sampai jumpa di tour berikutnya! 💪',
    color: '#be123c', accentBg: 'linear-gradient(135deg,#fff1f2,#fecdd3)',
  },
];
